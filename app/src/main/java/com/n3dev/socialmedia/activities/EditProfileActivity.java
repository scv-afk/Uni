...
import com.n3dev.socialmedia.models.User;
import com.n3dev.socialmedia.providers.AuthProvider;
import com.n3dev.socialmedia.providers.ImageProvider;
import com.n3dev.socialmedia.providers.UsersProvider;
import com.n3dev.socialmedia.utils.FileUtil;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(EditProfileActivity.this, "com.n3dev.socialmedia", photoFile);
