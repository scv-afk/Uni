...
import com.n3dev.socialmedia.adapters.CommentAdapter;
import com.n3dev.socialmedia.adapters.PostsAdapter;
import com.n3dev.socialmedia.adapters.SliderAdapter;
...
import com.n3dev.socialmedia.providers.CommentsProvider;
import com.n3dev.socialmedia.providers.LikesProvider;
import com.n3dev.socialmedia.providers.PostProvider;
import com.n3dev.socialmedia.models.SliderItem;
import com.n3dev.socialmedia.providers.UsersProvider;
import com.n3dev.socialmedia.utils.RelativeTime;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewNameCategory = findViewById(R.id.textViewCategory);
                ...
                if(documentSnapshot.exists()){
                    ...
                    if(documentSnapshot.contains("category")){
                        ...
                        if(category.equals("MUSIC")){
                            mImageViewCategory.setImageResource(R.drawable.icon_mu);
                        }
                        else if(category.equals("PODCAST")){
                            mImageViewCategory.setImageResource(R.drawable.icon_pd);
                        }
                        else if(category.equals("SHORTS")){
                            mImageViewCategory.setImageResource(R.drawable.icon_sh);
                        }
                        else if(category.equals("PEOPLE")){
                            mImageViewCategory.setImageResource(R.drawable.icon_ppl);
                        }
                    }
